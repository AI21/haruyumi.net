...
define('SITE_ROOT', '/public');

define('APP_CONTROLLER', '\\App\\Controllers\\');

define('SEND_MAIL_FROM', 'k.kyudo.xampp@gmail.com');
define('SEND_MAIL_FROM_NAME', '春日井弓道協会 情報システム');
...
define('CONTROLLER_NAME_WORKSHOP', 'workshop');
define('CONTROLLER_NAME_MEMBER', 'member');
define('CONTROLLER_NAME_CALENDER', 'calender');
...
define('UPLOAD_FILE_MAX_SIZE', 2048);

define('UPLOAD_FILE_EXT_ICON_PDF', '/assets/img/icon/pdf_64.png');
define('UPLOAD_FILE_EXT_ICON_EXCEL', '/assets/img/icon/excel_64.png');
define('UPLOAD_FILE_EXT_ICON_WORD', '/assets/img/icon/word_64.png');
define('UPLOAD_FILE_EXT_ICON_JPG', '/assets/img/icon/jpg_64.png');
define('UPLOAD_FILE_EXT_ICON_ZIP', '/assets/img/icon/zip_64.png');
