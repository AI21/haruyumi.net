...
return [
    ...
    'max_length'            => '{field}：{param}文字以内にしてください',
    'min_length'            => '{field}：{param}文字以上にしてください',
    'not_equals'            => 'The {field} field cannot be: {param}.',
    'not_in_list'           => 'The {field} field must not be one of: {param}.',
    'numeric'               => '{field}：半角数字のみにしてください',
    'regex_match'           => 'The {field} field is not in the correct format.',
    'required'              => '{field}：入力されていません',
    ...
    'valid_email'           => '{field}：メールアドレスの形式にしてください',
    ...
    'valid_date'            => '{field}：日付の形式にしてください',
    'valid_json'            => 'The {field} field must contain a valid json.',
    
    'is_hiragana'           => '{field}：ひらがなのみで入力してください',
    'is_unique_mail'        => '{field}：すでに登録されています',

    // Credit Cards
    'valid_cc_num' => '{field} does not appear to be a valid credit card number.',

    // Files
    'uploaded' => '{field}：ファイルが投稿されていません',
    // 'max_size' => '{field} is too large of a file.',
    'max_size' => '{field}：ファイルサイズがオーバーです',
    ...
    'ext_in'   => '{field}：ファイル形式が不正です',
    'max_dims' => '{field} is either not an image, or it is too wide or tall.',

    // Credit Cards
    'check_member' => '{field} ログインID・メールアドレスが重複しています',
];
